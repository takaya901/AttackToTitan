...
/// <summary>レイヤー名を定数で管理するクラスを作成するスクリプト</summary>
public static class LayerNameCreator
{
    ...
    private const string PATH = "Assets/Scripts/LayerName.cs";        // ファイルパス
    ...
    /// <summary>レイヤー名を定数で管理するクラスを作成します</summary>
    [MenuItem(ITEM_NAME)]
    public static void Create()
    {
        ...
        CreateScript();
        EditorUtility.DisplayDialog(FILENAME, "Created " + FILENAME, "OK");
    }

    /// <summary>スクリプトを作成します</summary>
    public static void CreateScript()
    {
        var builder = new StringBuilder();

        builder.AppendLine("/// <summary>レイヤー名を定数で管理するクラス</summary>");
    ...
    /// <summary>レイヤー名を定数で管理するクラスを作成できるかどうかを取得します</summary>
