...
/// <summary>タグ名を定数で管理するクラスを作成するスクリプト</summary>
public static class TagNameCreator
{
    ...
    private const string PATH = "Assets/Scripts/TagName.cs";      // ファイルパス
    ...
    public static void CreateScript()
    {
        ...
        builder.AppendLine("/// <summary>タグ名を定数で管理するクラス</summary>");
    ...
    /// <summary>タグ名を定数で管理するクラスを作成できるかどうかを取得します</summary>
